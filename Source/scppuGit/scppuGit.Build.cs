...
public class scppuGit : ModuleRules
{
	public scppuGit(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		if (bShouldDeterminGitStatus)
		{
			try
			{
				...
				PublicDefinitions.Add("GIT_COMPILED_COMMIT_HAS_LOCAL_CHANGES=" + (bHasLocalChanges ? "1" : "0"));
			}
			catch (Exception Exp)
			{
